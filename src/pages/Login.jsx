        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-bg-main">
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="text-center">
                    ...
                    <p className="text-xs text-text-secondary uppercase tracking-[0.3em] font-mono">System Access Point</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <Input
                                ...
                                autoComplete="email"
                                error={error && (error.includes('email') || error.includes('account') || error.includes('found')) ? error : ''}
                            />
                            ...
                            <Input
                                ...
                                error={error && (error.includes('password') || error.includes('credentials')) ? error : ''}
                            />
                        </div>
                        ...
                        {error && (
                            <div className="p-3 rounded-xl bg-danger/10 border border-danger/30 text-danger text-sm">
                                ...
                                {error.includes('No account found') && <p className="text-xs mt-1 opacity-90">Create an account via Sign up.</p>}
                                {error.includes('Incorrect password') && <p className="text-xs mt-1 opacity-90">Check your password or reset it.</p>}
                                {error.includes('Invalid email') && <p className="text-xs mt-1 opacity-90">Enter a valid email address.</p>}
                            </div>
                        )}
